...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-9 items-center space-x-1 rounded-xl border bg-white dark:bg-black bg-opacity-70 dark:bg-opacity-70 backdrop-blur-xl p-1 shadow-sm",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-lg px-3 py-1 text-sm font-medium outline-none hover:bg-accent hover:text-accent-foreground",
      className
    )}
    {...props}
  />
